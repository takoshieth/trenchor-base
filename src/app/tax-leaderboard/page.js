          ...
          {campaigns.length === 0 ? (
            <div className="col-span-full text-center py-20 border border-white/10 rounded-xl bg-black/30">
              ...
              <p className="text-white/50 text-sm mb-6">
                Run the tax leaderboard script to generate campaign data
              </p>
              <code className="text-xs bg-black/50 px-4 py-2 rounded font-mono text-[#00ff41]">
                node scripts/taxLeaderboard.js
              </code>
            </div>
          ) : (
